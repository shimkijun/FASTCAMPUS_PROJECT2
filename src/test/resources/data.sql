...
insert into person(`id`,`name`,`year_of_birthday`,`month_of_birthday`,`day_of_birthday`,`job`,`hobby`,`phone_number`,`address`) values (6,'tony',1991,07,10,'officer','reading','010-2222-5555','seoul')
